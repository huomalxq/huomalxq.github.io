...
<section class="study-hero">
  ...
  <article class="study-hero__card">
    ...
    <p>当前保留 Eagle Eye 数据分析 Agent 与开放原子大赛 Teco-RAG 两篇记录，去掉原来的分类层级。</p>
  </article>
</section>

<section class="study-grid study-grid--wide">
  <a class="study-card" href="eagle-eye-data-agent/">
    <span class="study-card__label">Project Review</span>
    <strong>Eagle Eye 数据分析 Agent</strong>
...
<section class="study-feed">
  ...
  <div class="feed-list">
    <article class="feed-item">
      ...
      <div>
        <strong><a href="eagle-eye-data-agent/">Eagle Eye 数据分析 Agent 后端项目复盘</a></strong>
        <p>整理企业自然语言问数项目的背景、架构、关键问题、解决方案和面试表达。</p>
      </div>
    </article>
    <article class="feed-item">
      <time datetime="2026-06-14">项目</time>
    ...
    <div class="feed-list">
      <article class="feed-item">
        ...
        <div>
          ...
          <p>移除原来的多层分类，将 Eagle Eye 和 Teco-RAG 两份本地 Markdown 整理为独立页面。</p>
        </div>
      </article>
      <article class="feed-item">
